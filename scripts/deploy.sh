...
# Deployment
# ----------------------
echo "▶️ Deploying application '$APP_NAME' to '$TARGET_DIR'..."

# 1. Navigate to project directory
if [ -d "$TARGET_DIR" ]; then
  cd "$TARGET_DIR"
  echo "    ⤵️ Navigated to $TARGET_DIR"
else
...
# echo "    ⤵️ Running PayloadCMS database migrations..."
...
if pm2 list | grep -q "$APP_NAME"; then
    echo "    ⤵️ Application is running in PM2. Reloading application..."
    ...
    echo "    ⤵️ Application is not running in PM2. Starting application..."
...
echo "    ⤵️ Waiting 5 seconds for app to initialize..."
sleep 5

echo "    ⤵️ Verifying PM2 process status..."
