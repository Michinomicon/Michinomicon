...
import { type InsertMode, type RepeatMode, useAudioStore } from '@/lib/audio-store'
...
function AudioQueueButton({ tooltip = false, tooltipLabel, ...props }: AudioQueueButtonProps) {
...
const AudioQueueRepeatMode = ({ className, ...props }: ComponentProps<typeof Toggle>) => {
...
const AudioQueueShuffle = ({
  ...
  const toggle = (
    <Toggle
      aria-label="Shuffle"
      className={cn(className, shuffleEnabled && 'bg-accent! text-accent-foreground!')}
...
const AudioQueuePreferences = ({
  ...
  return (
    <DropdownMenu>
      ...
      >
        <DropdownMenuLabel className="text-muted-foreground">Repeat Mode</DropdownMenuLabel>
        <DropdownMenuRadioGroup
        ...
        <DropdownMenuLabel className="text-muted-foreground">Insert Mode</DropdownMenuLabel>
    ...
    return (
      ...
      >
        <DialogTrigger asChild>
          <AudioQueueButton size="icon" tooltip tooltipLabel="Queue" variant="outline">
            <ListMusicIcon />
          </AudioQueueButton>
        </DialogTrigger>
        <DialogContent
