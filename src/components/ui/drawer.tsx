  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-1 w-25 shrink-0 rounded-none bg-muted group-data-[vaul-drawer-direction=bottom]/drawer-content:block md:rounded-full" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
