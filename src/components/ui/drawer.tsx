...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        'fixed inset-0 z-50 bg-black data-closed:animate-out data-closed:fade-out-0 data-open:animate-in data-open:fade-in-0 supports-backdrop-filter:backdrop-blur-xs',
        className,
      )}
      {...props}
    />
    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          'data-[vaul-drawer-direction=bottom]:inset-x-0 data-[vaul-drawer-direction=bottom]:bottom-0 data-[vaul-drawer-direction=bottom]:mt-24 data-[vaul-drawer-direction=bottom]:max-h-screen data-[vaul-drawer-direction=bottom]:rounded-t-xl data-[vaul-drawer-direction=bottom]:border-t',
        ...
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-1 w-25 shrink-0 rounded-none bg-primary/30 group-data-[vaul-drawer-direction=bottom]/drawer-content:block md:rounded-full" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
