  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          'absolute inset-y-0 z-20 hidden w-[0.1em] -translate-x-1/2 bg-sidebar-border/80 transition-all ease-linear',
          'group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-0.5 hover:after:bg-sidebar-border sm:flex',
  ...
  ({ className, ...props }, ref) => {
    return (
      <main
        ref={ref}
        className={cn(
          'relative flex shrink grow basis-full flex-col bg-none',
          'md:peer-data-[variant=inset]:m-0',
          'md:peer-data-[variant=inset]:mr-0 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:mr-0',
