  ...
  return (
    ...
    >
      <SortableContext items={items}>
        <ul
          className={cn('flex list-inside list-none list-image-none flex-col p-0', className)}
          role="application"
        >
      ...
      {mounted &&
        createPortal(
          <Overlay>
            {activeItem && activeIndex !== null ? renderItem(activeItem, activeIndex, true) : null}
          </Overlay>,
          document.body,
        )}
    </DndContext>
...
type SortableItemProps<TItem extends SortableBaseItem> = React.PropsWithChildren<{
  id: TItem['id']
  className?: string
}>
